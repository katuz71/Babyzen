...
import { TouchableOpacity, StyleSheet, Animated, ActivityIndicator, Easing } from 'react-native';
...
export const RecordingSphere = React.memo(({ isRecording, isAnalyzing, onPress }: RecordingSphereProps) => {
    ...
    return (
        <TouchableOpacity onPress={onPress} activeOpacity={0.9} style={styles.sphereContainer}>
